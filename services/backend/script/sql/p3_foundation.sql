-- Yijiatong P3 foundation schema derived from RuoYi-Vue-Plus v6.0.0.
-- Product-domain tables are intentionally excluded. Bootstrap login is disabled until environment activation.
-- ----------------------------
-- 第三方平台授权表
-- ----------------------------
...
insert into sys_dept values(1761000000000000100, 0, '0', 'Yijiatong', null, 0, null, '', '', '0', '0', null, null, sysdate(), null, null);
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1761100000000000001, 1761000000000000100, 'bootstrap-disabled', 'Bootstrap Disabled', 'sys_user', '', '', '2', null, '!', '1', '0', '127.0.0.1', null, 1761000000000000100, null, sysdate(), null, null, 'Activated only from explicit environment credentials');
...
-- 初始化-岗位信息表数据
-- ----------------------------
insert into sys_post values(1761200000000000001, 1761000000000000100, 'admin', null, 'Administrator', 1, '0', '0', 1761000000000000100, null, sysdate(), null, null, 'P3 foundation role');
...
-- 初始化-角色信息表数据
-- ----------------------------
insert into sys_role values(1761300000000000001, 'Super Administrator', 'superadmin', 1, 1, 1, 1, '0', '0', 1761000000000000100, null, sysdate(), null, null, 'P3 foundation administrator');
...
insert into sys_config values(1761700000000000001, 'User management - initial password', 'sys.user.initPassword', 'DISABLED_CHANGE_BEFORE_USE', 'Y', 1761000000000000100, null, sysdate(), null, null, 'Must be changed before user creation is enabled');
...
insert into sys_client values (1762000000000000001, 'yijiatong-p3-admin', 'admin-ui', 'disabled', 'password', 'pc', null, '127.0.0.1,::1', 1800, 604800, 0, 0, 1761000000000000100, null, sysdate(), null, sysdate());
